...
async def send_thumbnail(bot, update):
    ...
    try:
        ...
        await update.reply_photo(
            photo=thumbnail,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('Creator ⭐', url='https://telegram.me/arvinxoxo')]]),
            quote=True
        )
        ...
        await message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('Creator ⭐', url='https://t.me/arvinxoxo')]])
        )
